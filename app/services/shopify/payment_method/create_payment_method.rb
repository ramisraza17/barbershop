  ...
  module PaymentMethod
    class CreatePaymentMethod
      ...
      def create_payment_method
        ...
        query = "mutation customerPaymentMethodCreditCardCreate($billingAddress: MailingAddressInput!, $customerId: ID!, $sessionId: String!) {  customerPaymentMethodCreditCardCreate(billingAddress: $billingAddress, customerId: $customerId, sessionId: $sessionId) {  customerPaymentMethod { id } userErrors { field, message} } }"
        variable = {
